...
type WindowsIntegrationsLogsSuite struct {
...
func TestIntegrationsLogsSuite(t *testing.T) {
	...
	e2e.Run(t, &WindowsIntegrationsLogsSuite{}, suiteParams...)
}

// TestWriteTenLogsCheck ensures a check that logs are written to the file ten
// logs at a time
func (v *WindowsIntegrationsLogsSuite) TestWriteTenLogsCheck() {
	...
	v.UpdateEnv(awshost.Provisioner(awshost.WithAgentOptions(
		agentparams.WithLogs(),
		agentparams.WithFile("C:/ProgramData/Datadog/conf.d/writeTenLogs.yaml", string(yamlData), true),
		agentparams.WithFile("C:/ProgramData/Datadog/checks.d/writeTenLogs.py", customIntegration, true))))
...
// log file is rotated
func (v *WindowsIntegrationsLogsSuite) TestIntegrationLogFileRotation() {
	...
	v.UpdateEnv(awshost.Provisioner(awshost.WithAgentOptions(
		agentparams.WithLogs(),
		agentparams.WithFile("C:/ProgramData/Datadog/conf.d/rotation.yaml", string(yamlData), true),
		agentparams.WithFile("C:/ProgramData/Datadog/checks.d/rotation.py", customIntegration, true))))
