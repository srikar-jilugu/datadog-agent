...
require (
	...
	github.com/DataDog/datadog-agent/test/fakeintake v0.0.0-20250123182127-b55818e09cf4
...
require (
	...
	github.com/DataDog/datadog-agent/comp/netflow/payload v0.0.0-20250123182127-b55818e09cf4 // indirect
