...
require (
	...
	github.com/DataDog/datadog-agent/pkg/util/pointer v0.53.2-rc.11
	github.com/DataDog/datadog-agent/pkg/util/testutil v0.53.2-rc.11
	github.com/DataDog/datadog-agent/pkg/version v0.53.2-rc.11
	github.com/DataDog/datadog-agent/test/fakeintake v0.53.2-rc.11
	...
	github.com/DataDog/test-infra-definitions v0.0.0-20250220160206-c809c5306214
