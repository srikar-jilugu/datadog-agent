...
require go.opentelemetry.io/collector/extension/xextension v0.121.0 // indirect
...
require (
	...
	github.com/DataDog/datadog-agent/pkg/util/otel v0.0.0-00010101000000-000000000000 // indirect
