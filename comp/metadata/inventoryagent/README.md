...
- `agent_metadata` - **dict of string to JSON type**:
  ...
  - `feature_dynamic_instrumentation_module_enabled` - **bool**: True if dynamic instrumentation module is enabled (see: `dynamic_instrumentation_module.enabled` config option).
