...
require (
	...
	github.com/DataDog/datadog-agent/pkg/fips v0.64.3
...
require (
	...
	github.com/DataDog/datadog-agent/pkg/config/mock v0.67.0-devel.0.20250429165338-2444768c3033 // indirect
