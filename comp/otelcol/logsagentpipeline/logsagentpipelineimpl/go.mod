...
require (
	...
	github.com/DataDog/datadog-agent/pkg/logs/auditor v0.67.0-devel.0.20250429165338-2444768c3033
	...
	github.com/DataDog/datadog-agent/pkg/status/health v0.64.3
