...
require (
	...
	github.com/DataDog/datadog-agent/comp/otelcol/ddflareextension/def v0.61.0
	...
	github.com/DataDog/datadog-agent/pkg/util/utilizationtracker v0.61.0
...
require (
	...
	github.com/DataDog/datadog-agent/comp/core/log/impl-trace v0.61.0
	github.com/DataDog/datadog-agent/comp/core/log/mock v0.61.0
	github.com/DataDog/datadog-agent/comp/core/secrets v0.61.0
	github.com/DataDog/datadog-agent/comp/core/status v0.61.0
	github.com/DataDog/datadog-agent/comp/core/status/statusimpl v0.61.0
	...
	github.com/DataDog/datadog-agent/comp/forwarder/defaultforwarder v0.61.0
	github.com/DataDog/datadog-agent/comp/forwarder/orchestrator/orchestratorinterface v0.61.0
	github.com/DataDog/datadog-agent/comp/logs/agent/config v0.61.0
	github.com/DataDog/datadog-agent/comp/netflow/payload v0.61.0
	github.com/DataDog/datadog-agent/comp/otelcol/collector-contrib/def v0.61.0
	github.com/DataDog/datadog-agent/comp/otelcol/collector-contrib/impl v0.61.0
	github.com/DataDog/datadog-agent/comp/otelcol/converter/def v0.61.0
	github.com/DataDog/datadog-agent/comp/otelcol/converter/impl v0.61.0
	...
	github.com/DataDog/datadog-agent/comp/otelcol/otlp/components/exporter/datadogexporter v0.61.0
	github.com/DataDog/datadog-agent/comp/otelcol/otlp/components/exporter/logsagentexporter v0.61.0
	...
	github.com/DataDog/datadog-agent/comp/otelcol/otlp/components/processor/infraattributesprocessor v0.61.0
	...
	github.com/DataDog/datadog-agent/comp/trace/compression/impl-zstd v0.61.0
	github.com/DataDog/datadog-agent/pkg/aggregator/ckey v0.61.0
	...
	github.com/DataDog/datadog-agent/pkg/logs/util/testutils v0.61.0
	github.com/DataDog/datadog-agent/pkg/metrics v0.61.0
	github.com/DataDog/datadog-agent/pkg/networkdevice/profile v0.61.0
	github.com/DataDog/datadog-agent/pkg/orchestrator/model v0.61.0
	github.com/DataDog/datadog-agent/pkg/process/util/api v0.61.0
	github.com/DataDog/datadog-agent/pkg/proto v0.61.0
	github.com/DataDog/datadog-agent/pkg/security/seclwin v0.61.0
	github.com/DataDog/datadog-agent/pkg/serializer v0.61.0
	github.com/DataDog/datadog-agent/pkg/status/health v0.61.0
	github.com/DataDog/datadog-agent/pkg/tagger/types v0.61.0
	...
	github.com/DataDog/datadog-agent/pkg/util/common v0.61.0
	github.com/DataDog/datadog-agent/pkg/util/containers/image v0.61.0
	github.com/DataDog/datadog-agent/pkg/util/executable v0.61.0
	github.com/DataDog/datadog-agent/pkg/util/filesystem v0.61.0
	github.com/DataDog/datadog-agent/pkg/util/flavor v0.61.0
	...
	github.com/DataDog/datadog-agent/pkg/util/json v0.61.0
	...
	github.com/DataDog/datadog-agent/pkg/util/testutil v0.61.0
...
replace (
	...
	github.com/aquasecurity/trivy => github.com/DataDog/trivy v0.0.0-20241126101205-8517f9b946f4
