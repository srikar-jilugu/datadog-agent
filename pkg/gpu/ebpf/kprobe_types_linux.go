...
const SizeofCudaKernelLaunch = 0xc8
const SizeofCudaMemEvent = 0xb8
const SizeofCudaEventHeader = 0xa0
const SizeofCudaSync = 0xa0
const SizeofCudaSetDeviceEvent = 0xa8
