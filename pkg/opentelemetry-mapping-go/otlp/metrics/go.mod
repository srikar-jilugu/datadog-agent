...
require (
	github.com/DataDog/datadog-agent/pkg/opentelemetry-mapping-go/otlp/attributes v0.0.0-20250429165338-2444768c3033
	github.com/DataDog/datadog-agent/pkg/proto v0.66.0-devel
	github.com/DataDog/datadog-agent/pkg/util/quantile v0.0.0-20250429165338-2444768c3033
	github.com/DataDog/datadog-agent/pkg/util/quantile/sketchtest v0.0.0-20250429165338-2444768c3033
