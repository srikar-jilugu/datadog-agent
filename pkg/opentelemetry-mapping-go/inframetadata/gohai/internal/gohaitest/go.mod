...
require (
	github.com/DataDog/datadog-agent/pkg/opentelemetry-mapping-go/inframetadata v0.0.0-20250429165338-2444768c3033
	github.com/DataDog/gohai v0.0.0-20230524154621-4316413895ee
	github.com/stretchr/testify v1.10.0
)

require (
	github.com/DataDog/datadog-agent/pkg/opentelemetry-mapping-go/otlp/attributes v0.0.0-20250430092323-89fdefa55d7d // indirect
