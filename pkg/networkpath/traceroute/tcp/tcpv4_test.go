...
func TestCreateRawTCPSyn(t *testing.T) {
	...
	ipHeader, pktBytes, err := tcp.createRawTCPSyn(seqNum, identification, ttl)
...
func TestCreateRawTCPSynBuffer(t *testing.T) {
	...
	ipHeader, pktBytes, headerLength, err := tcp.createRawTCPSynBuffer(seqNum, identification, ttl)
