...
func (t *TCPv4) getTracerouteDriver(params Params) (*tcpDriver, error) {
	...
	driver, err := newTCPDriver(t, params, sink, source)
	if err != nil {
		return nil, fmt.Errorf("getTracerouteDriver failed to make newTCPDriver: %w", err)
	}
